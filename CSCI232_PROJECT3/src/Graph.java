...
public class Graph {
    ...
    public boolean isSimple() {
        try {
            ...
            System.out.println("Cannot determine simplicity.  O THOU wicked and disobedient spirit, because thou hast rebelled, and hast not obeyed nor regarded my words which I have rehearsed; they being all glorious and incomprehensible names of the true GOD, the maker and\n" +
                    "\n" +
